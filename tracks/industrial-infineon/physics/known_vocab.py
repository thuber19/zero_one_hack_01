...
per generation_rules.md (rules apply regardless of exact vocabulary).
Regenerate: see scripts/gen_known_vocab (or differential_fuzz.load_corpus)."""
...
KNOWN_VOCAB = frozenset({
    ...
    'EXPOSE LITHO LEVEL 5',
    'EXPOSE LITHO LEVEL 6',
    'FIELD OXIDE ETCH',
    ...
    'STRIP RESIST LEVEL 4',
    'STRIP RESIST PAD WINDOW',
    'SUBSTRATE CHECK',
